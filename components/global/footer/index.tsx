...
const Footer = () => {
  return (
    <footer className=" relative overflow-hidden">
      <div className="container px-20">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-7 text-base text-body-color dark:text-dark-6">
                Clothify is a platform that provides you with the best quality
                of clothes, shoes, and jewellery. We have a wide range of
          ...
          <LinkGroup header="Resources">
            <NavLink link="/#" label="Clothes" />
            <NavLink link="/#" label="Shoes" />
            <NavLink link="/#" label="Jewellery" />
            <NavLink link="/#" label="New" />
          </LinkGroup>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12 flex flex-col justify-between">
            ...
            <div className="w-full space-y-4">
              ...
              <div className="grid grid-cols-2 grid-rows-1 gap-4">
                <Link
                  href={"/"}
                  className="h-14 flex items-center justify-center bg-black/80 rounded-lg transition-all du hover:bg-black "
                >
                  <Icons.AppleStore />
                </Link>
                <Link
      ...
      <span className="block font-bold -mb-56">
        <TextHoverEffect text="CLOTHIFY" />
      </span>
    </footer>
  );
};
